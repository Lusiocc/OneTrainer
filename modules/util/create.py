    ...
    match config.optimizer.optimizer:
        ...
        case Optimizer.AUTOMAGIC_SINKGD:
            ...
            optimizer = AutomagicSinkGD(
                ...
                eta=optimizer_config.eta if optimizer_config.eta is not None else 2.0,
                orthograd=optimizer_config.orthograd if optimizer_config.orthograd is not None else False,
