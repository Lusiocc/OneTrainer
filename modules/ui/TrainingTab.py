...
class TrainingTab:
    ...
    def __create_noise_frame(
        ...
        components.entry(frame, frame_row, 1, self.ui_state, "min_noising_strength", required=True)
        frame_row += 1
        ...
        components.entry(frame, frame_row, 1, self.ui_state, "max_noising_strength", required=True)
        frame_row += 1
        ...
        components.entry(frame, frame_row, 1, self.ui_state, "noising_weight", required=True)
        frame_row += 1
        ...
        components.entry(frame, frame_row, 1, self.ui_state, "noising_bias", required=True)
        frame_row += 1
        ...
        components.entry(frame, frame_row, 1, self.ui_state, "timestep_shift", required=True)
        frame_row += 1
    ...
    def __create_loss_frame(self, master, row, supports_vb_loss: bool = False):
        ...
        mse_entry = components.entry(frame, 1, 1, self.ui_state, "mse_strength", required=True)
        ...
        mae_entry = components.entry(frame, 2, 1, self.ui_state, "mae_strength", required=True)
        ...
        log_cosh_entry = components.entry(frame, 3, 1, self.ui_state, "log_cosh_strength", required=True)
        ...
        huber_strength_entry = components.entry(frame, 4, 1, self.ui_state, "huber_strength", required=True)

        # Huber Delta
        components.label(frame, 5, 0, "Huber Delta",
                         tooltip="Delta parameter for huber loss")
        huber_delta_entry = components.entry(frame, 5, 1, self.ui_state, "huber_delta", required=True)
        ...
        if supports_vb_loss:
            ...
            vb_loss_entry = components.entry(frame, 10, 1, self.ui_state, "vb_loss_strength", required=True)
